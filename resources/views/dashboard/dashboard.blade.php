...
<div class="min-h-screen p-8">
    ...
    <div class="bg-white p-4 rounded-lg shadow-sm mb-8 flex justify-between items-center">
        ...
        <a href="#" class="px-4 py-2 text-gray-600 hover:bg-gray-100 rounded-md">Documentação</a>
      </div>
    </div>
    <!-- Stats Grid -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <table class="w-full">
            <thead>
              <tr class="bg-gray-200">
                ...
                <th class="px-6 py-3 text-right text-sm font-medium text-gray-500"><span class="mr-6">Ações </span></th>
                </div>
              </tr>
            </thead>
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="flex space-x-4 justify-end px-6 py-4 text-sm text-gray-900"><a href="{{route('dashboard.site.index', ['search' => $recent->name])}}" class="bg-orange-500 text-white px-4 py-2 rounded-lg hover:bg-orange-600">Visualizar</a></td>
