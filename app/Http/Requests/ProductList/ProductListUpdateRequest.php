...
class ProductListUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'slug' => 'required|string|max:255|unique:' . $db . '.product_list,slug,' . $this->route()->parameter('id'),
            ...
            'discount_qty_upersell' => 'nullable|numeric',
            'discount_amount_upersell' => 'nullable|numeric',
            ...
            'discount_qty_downsell' => 'nullable|numeric',
            'discount_amount_downsell' => 'nullable|numeric',
